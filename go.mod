...
require (
	...
	chainmaker.org/chainmaker/txpool-batch/v2 v2.3.1-0.20221123024710-94130737363b
	...
	chainmaker.org/chainmaker/vm-native/v2 v2.3.2-0.20221122143330-82d42c2628cd

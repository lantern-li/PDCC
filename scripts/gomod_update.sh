...
go get chainmaker.org/chainmaker/common/v2@v2.3.6_sz
go get chainmaker.org/chainmaker/localconf/v2@v2.3.5_sz
go get chainmaker.org/chainmaker/logger/v2@${PRE_BRANCH}
go get chainmaker.org/chainmaker/pb-go/v2@v2.3.6_sz
go get chainmaker.org/chainmaker/protocol/v2@v2.3.7_sz
...
go get chainmaker.org/chainmaker/vm-native/v2@v2.3.6_sz
...
go get chainmaker.org/chainmaker/txpool-batch/v2@v2.3.4_sz

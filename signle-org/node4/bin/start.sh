...
config_file="../config/node4/chainmaker.yml"
...
pid=$(ps -ef | grep chainmaker | grep "\-c ../config/node4/chainmaker.yml" | grep -v grep |  awk  '{print $2}')
if [ -z "${pid}" ];then
    ...
    nohup ./chainmaker start -c ../config/node4/chainmaker.yml > panic.log 2>&1 &

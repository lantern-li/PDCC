...
config_file="../config/node1/chainmaker.yml"
...
pid=$(ps -ef | grep chainmaker | grep "\-c ../config/node1/chainmaker.yml" | grep -v grep |  awk  '{print $2}')
if [ -z "${pid}" ];then
    ...
    # start chainmaker
    #nohup ./chainmaker start -c ../config/wx-org1.chainmaker.org/chainmaker.yml > /dev/null 2>&1 &
    nohup ./chainmaker start -c ../config/node1/chainmaker.yml > panic.log 2>&1 &

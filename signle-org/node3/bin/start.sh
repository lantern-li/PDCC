...
config_file="../config/node3/chainmaker.yml"
...
pid=$(ps -ef | grep chainmaker | grep "\-c ../config/node3/chainmaker.yml" | grep -v grep |  awk  '{print $2}')
if [ -z "${pid}" ];then
    ...
    # start chainmaker
    #nohup ./chainmaker start -c ../config/wx-org3.chainmaker.org/chainmaker.yml > /dev/null 2>&1 &
    nohup ./chainmaker start -c ../config/node3/chainmaker.yml > panic.log 2>&1 &

...
// GetEncryptGasUsed2312 returns encrypt gas used
func GetEncryptGasUsed2312(gasConfig *gasutils.GasConfig, gasUsed uint64,
	contractName, key, value []byte) (uint64, error) {

	return gasUsed, nil
}

// GetDecryptGasUsed2312 returns decrypt gas used
func GetDecryptGasUsed2312(gasConfig *gasutils.GasConfig, gasUsed uint64,
	contractName, key, value []byte) (uint64, error) {

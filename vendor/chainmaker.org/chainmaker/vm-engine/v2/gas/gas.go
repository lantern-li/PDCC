...
// GetEncryptGasUsed returns encrypt gas used
func GetEncryptGasUsed(blockVersion uint32, gasConfig *gasutils.GasConfig,
	gasUsed uint64, contractName, key, value []byte) (uint64, error) {
	if blockVersion < blockVersion2312 {
		return GetEncryptGasUsedLt2312(gasUsed, value)
	}

	return GetEncryptGasUsed2312(gasConfig, gasUsed, contractName, key, value)
}

// GetDecryptGasUsed returns decrypt gas used
func GetDecryptGasUsed(blockVersion uint32, gasConfig *gasutils.GasConfig,
	gasUsed uint64, contractName, key, value []byte) (uint64, error) {

	if blockVersion < blockVersion2312 {
		return GetDecryptGasUsedLt2312(gasUsed, value)
	}

	return GetDecryptGasUsed2312(gasConfig, gasUsed, contractName, key, value)
}

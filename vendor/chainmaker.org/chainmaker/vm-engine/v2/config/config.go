...
const (
	...
	KeyEncryptDataKey   = "KEY_ENCRYPT_DATA_KEY"
	KeyEncryptDataValue = "KEY_ENCRYPT_DATA_VALUE"
	KeyDecryptDataKey   = "KEY_DECRYPT_DATA_KEY"
	KeyDecryptDataValue = "KEY_DECRYPT_DATA_VALUE"
)

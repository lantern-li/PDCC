...
// TxWrite describes a write/delete operation on a key
type TxWrite struct {
	// write key
	Key []byte `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// write value
...
// VersionedTxWrite represents a TxWrite with an associated version.
type VersionedTxWrite struct {
	Write   *TxWrite `protobuf:"bytes,1,opt,name=write,proto3" json:"write,omitempty"`
	Version uint64   `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`
}

func (m *VersionedTxWrite) Reset()         { *m = VersionedTxWrite{} }
func (m *VersionedTxWrite) String() string { return proto.CompactTextString(m) }
func (*VersionedTxWrite) ProtoMessage()    {}
func (*VersionedTxWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b37461e5519cef2, []int{3}
}
func (m *VersionedTxWrite) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VersionedTxWrite) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VersionedTxWrite.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VersionedTxWrite) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VersionedTxWrite.Merge(m, src)
}
func (m *VersionedTxWrite) XXX_Size() int {
	return m.Size()
}
func (m *VersionedTxWrite) XXX_DiscardUnknown() {
	xxx_messageInfo_VersionedTxWrite.DiscardUnknown(m)
}

var xxx_messageInfo_VersionedTxWrite proto.InternalMessageInfo

func (m *VersionedTxWrite) GetWrite() *TxWrite {
	if m != nil {
		return m.Write
	}
	return nil
...
func (m *VersionedTxWrite) GetVersion() uint64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (*TxRWSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b37461e5519cef2, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*VersionedTxWrite)(nil), "common.VersionedTxWrite")
...
var fileDescriptor_3b37461e5519cef2 = []byte{
	...
	,
}
...
func (m *VersionedTxWrite) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VersionedTxWrite) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VersionedTxWrite) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Version != 0 {
		i = encodeVarintRwset(dAtA, i, uint64(m.Version))
		i--
		dAtA[i] = 0x10
	}
	if m.Write != nil {
...
func (m *VersionedTxWrite) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VersionedTxWrite) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionedTxWrite: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionedTxWrite: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

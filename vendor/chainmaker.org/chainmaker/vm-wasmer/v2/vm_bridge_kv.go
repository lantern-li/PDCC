...
// GetContractEncryptLen get contract encrypt value len
func (s *WaciInstance) GetContractEncryptLen() int32 {
	return s.GetContractEncryptCore(true)
}

// GetContractEncrypt get contract encrypt value
func (s *WaciInstance) GetContractEncrypt() int32 {
	return s.GetContractEncryptCore(false)
}

// GetContractEncryptCore get contract encrypt value core
func (s *WaciInstance) GetContractEncryptCore(isLen bool) int32 {
	data, err := wacsi.ContractEncrypt(s.RequestBody, s.Sc.kmsProvider, s.Memory, s.Sc.EncryptCache, isLen)
	s.Sc.EncryptCache = data // reset _data
	if err != nil {
		s.recordMsg(err.Error())
		return protocol.ContractSdkSignalResultFail
	}
...
// GetContractDecryptLen get contract decrypt value len
func (s *WaciInstance) GetContractDecryptLen() int32 {
	return s.GetContractDecryptCore(true)
}

// GetContractDecrypt get contract decrypt value
func (s *WaciInstance) GetContractDecrypt() int32 {
	return s.GetContractDecryptCore(false)
}

// GetContractDecryptCore get contract decrypt core
func (s *WaciInstance) GetContractDecryptCore(isLen bool) int32 {
	data, err := wacsi.ContractDecrypt(s.RequestBody, s.Sc.kmsProvider, s.Memory, s.Sc.DecryptCache, isLen)
	s.Sc.DecryptCache = data // reset _data
	if err != nil {
		s.recordMsg(err.Error())
		return protocol.ContractSdkSignalResultFail
	}

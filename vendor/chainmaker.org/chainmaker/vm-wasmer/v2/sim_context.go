...
type SimContext struct {
	...
	EncryptCache  []byte // cache call method encrypt value result, one cache per transaction
	DecryptCache  []byte // cache call method decrypt value result, one cache per transaction
	ChainId       string

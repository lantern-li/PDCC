...
type SDKInterface interface {
	...
	// ### 3.29  更新调度类型payload生成
	// ```go
	CreateChainConfigScheduleUpdatePayload(scheduleType, algorithmType uint32) (*common.Payload, error)
	...
	//   - ruleType: 规则类型
	// ```go
	SubscribeBlockWithRule(ctx context.Context, startBlock, endBlock int64, withRWSet, onlyHeader bool, contractName,
		method string, ruleType txassign.RuleType) (<-chan interface{}, error)
	// ```

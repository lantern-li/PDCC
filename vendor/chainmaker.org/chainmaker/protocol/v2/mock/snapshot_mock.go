...
// ApplyWritesToWriteTable mocks base method.
func (m *MockSnapshot) ApplyWritesToWriteTable(writes []*common.TxWrite) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ApplyWritesToWriteTable", writes)
}

// ApplyWritesToWriteTable indicates an expected call of ApplyWritesToWriteTable.
func (mr *MockSnapshotMockRecorder) ApplyWritesToWriteTable(writes interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyWritesToWriteTable", reflect.TypeOf((*MockSnapshot)(nil).ApplyWritesToWriteTable), writes)
}
...
// GetKeyWithLock mocks base method.
func (m *MockSnapshot) GetKeyWithLock(txExecSeq int, contractName, lockerName, txId string, key []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKeyWithLock", txExecSeq, contractName, lockerName, txId, key)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetKeyWithLock indicates an expected call of GetKeyWithLock.
func (mr *MockSnapshotMockRecorder) GetKeyWithLock(txExecSeq, contractName, lockerName, txId, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKeyWithLock", reflect.TypeOf((*MockSnapshot)(nil).GetKeyWithLock), txExecSeq, contractName, lockerName, txId, key)
}
...
func (m *MockSnapshot) GetKeysWithLock(txExecSeq int, keys []*vm.BatchKey, lockerName, txId string) ([]*vm.BatchKey, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKeysWithLock", txExecSeq, keys, lockerName, txId)
	ret0, _ := ret[0].([]*vm.BatchKey)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSnapshotMockRecorder) GetKeysWithLock(txExecSeq, keys, lockerName, txId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKeysWithLock", reflect.TypeOf((*MockSnapshot)(nil).GetKeysWithLock), txExecSeq, keys, lockerName, txId)
}
...
func (m *MockSnapshot) Lock(lockerName, txId string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", lockerName, txId)
	ret0, _ := ret[0].(error)
	return ret0
}

// Lock indicates an expected call of Lock.
func (mr *MockSnapshotMockRecorder) Lock(lockerName, txId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Lock", reflect.TypeOf((*MockSnapshot)(nil).Lock), lockerName, txId)
}

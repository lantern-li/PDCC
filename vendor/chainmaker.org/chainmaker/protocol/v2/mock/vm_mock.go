...
// ContractDecrypt mocks base method.
func (m *MockWacsi) ContractDecrypt(requestBody []byte, kmsProvider protocol.KMSProvider, memory, data []byte, isLen bool) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ContractDecrypt", requestBody, kmsProvider, memory, data, isLen)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ContractDecrypt indicates an expected call of ContractDecrypt.
func (mr *MockWacsiMockRecorder) ContractDecrypt(requestBody, kmsProvider, memory, data, isLen interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ContractDecrypt", reflect.TypeOf((*MockWacsi)(nil).ContractDecrypt), requestBody, kmsProvider, memory, data, isLen)
}

// ContractEncrypt mocks base method.
func (m *MockWacsi) ContractEncrypt(requestBody []byte, kmsProvider protocol.KMSProvider, memory, data []byte, isLen bool) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ContractEncrypt", requestBody, kmsProvider, memory, data, isLen)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ContractEncrypt indicates an expected call of ContractEncrypt.
func (mr *MockWacsiMockRecorder) ContractEncrypt(requestBody, kmsProvider, memory, data, isLen interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ContractEncrypt", reflect.TypeOf((*MockWacsi)(nil).ContractEncrypt), requestBody, kmsProvider, memory, data, isLen)
}
...
// AppendRelyCacheIntoRelyCache mocks base method.
func (m *MockTxSimContext) AppendRelyCacheIntoRelyCache(relyCache []map[string][]byte) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AppendRelyCacheIntoRelyCache", relyCache)
}

// AppendRelyCacheIntoRelyCache indicates an expected call of AppendRelyCacheIntoRelyCache.
func (mr *MockTxSimContextMockRecorder) AppendRelyCacheIntoRelyCache(relyCache interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendRelyCacheIntoRelyCache", reflect.TypeOf((*MockTxSimContext)(nil).AppendRelyCacheIntoRelyCache), relyCache)
}

// AppendWriteSetIntoRelyCache mocks base method.
func (m *MockTxSimContext) AppendWriteSetIntoRelyCache(writeSet []*common.TxWrite) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AppendWriteSetIntoRelyCache", writeSet)
}

// AppendWriteSetIntoRelyCache indicates an expected call of AppendWriteSetIntoRelyCache.
func (mr *MockTxSimContextMockRecorder) AppendWriteSetIntoRelyCache(writeSet interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendWriteSetIntoRelyCache", reflect.TypeOf((*MockTxSimContext)(nil).AppendWriteSetIntoRelyCache), writeSet)
}
...
// GetKeysWithLock mocks base method.
func (m *MockTxSimContext) GetKeysWithLock(keys []*vm.BatchKey, lockerName string) ([]*vm.BatchKey, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKeysWithLock", keys, lockerName)
	ret0, _ := ret[0].([]*vm.BatchKey)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetKeysWithLock indicates an expected call of GetKeysWithLock.
func (mr *MockTxSimContextMockRecorder) GetKeysWithLock(keys, lockerName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKeysWithLock", reflect.TypeOf((*MockTxSimContext)(nil).GetKeysWithLock), keys, lockerName)
}
...
// GetRelyCache mocks base method.
func (m *MockTxSimContext) GetRelyCache() []map[string][]byte {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRelyCache")
	ret0, _ := ret[0].([]map[string][]byte)
	return ret0
}

// GetRelyCache indicates an expected call of GetRelyCache.
func (mr *MockTxSimContextMockRecorder) GetRelyCache() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRelyCache", reflect.TypeOf((*MockTxSimContext)(nil).GetRelyCache))
}
...
func (m *MockTxSimContext) GetWithLock(contractName, lockerName string, key []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWithLock", contractName, lockerName, key)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTxSimContextMockRecorder) GetWithLock(contractName, lockerName, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWithLock", reflect.TypeOf((*MockTxSimContext)(nil).GetWithLock), contractName, lockerName, key)
}
...
func (m *MockTxSimContext) Lock(lockerName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", lockerName)
	ret0, _ := ret[0].(error)
	return ret0
}

// Lock indicates an expected call of Lock.
func (mr *MockTxSimContextMockRecorder) Lock(lockerName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Lock", reflect.TypeOf((*MockTxSimContext)(nil).Lock), lockerName)
}
...
// PutRelyTxRWSetTable mocks base method.
func (m *MockTxSimContext) PutRelyTxRWSetTable(relyTxRWSetTable []*common.TxRWSet) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PutRelyTxRWSetTable", relyTxRWSetTable)
}

// PutRelyTxRWSetTable indicates an expected call of PutRelyTxRWSetTable.
func (mr *MockTxSimContextMockRecorder) PutRelyTxRWSetTable(relyTxRWSetTable interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutRelyTxRWSetTable", reflect.TypeOf((*MockTxSimContext)(nil).PutRelyTxRWSetTable), relyTxRWSetTable)
}

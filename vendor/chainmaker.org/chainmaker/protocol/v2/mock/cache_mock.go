...
func (m *MockProposalCache) GetProposedBlock(b *common.Block) *protocol.ProposalData {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProposedBlock", b)
	ret0, _ := ret[0].(*protocol.ProposalData)
	return ret0
}
...
func (m *MockProposalCache) SetProposedBlock(proposalData *protocol.ProposalData, selfProposed bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetProposedBlock", proposalData, selfProposed)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetProposedBlock indicates an expected call of SetProposedBlock.
func (mr *MockProposalCacheMockRecorder) SetProposedBlock(proposalData, selfProposed interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetProposedBlock", reflect.TypeOf((*MockProposalCache)(nil).SetProposedBlock), proposalData, selfProposed)
}

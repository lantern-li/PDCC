...
type rpcConfig struct {
	...
	EnableTxTurbo                          bool             `mapstructure:"enable_tx_turbo"`
}
...
type subscriberConfig struct {
	RateLimitConfig rateLimitConfig `mapstructure:"ratelimit"`
	SendPool        poolConfig      `mapstructure:"send_pool"`
	FilterPool      poolConfig      `mapstructure:"filter_pool"`
}
...
type vmConfig struct {
	...
	Wasmer     map[string]interface{} `mapstructure:"wasmer"`
}
...
type coreConfig struct {
	...
	SchedulerType int32          `mapstructure:"scheduler_type"`
}
...
type CMConfig struct {
	...
	KMSConfig        []KMSBasicConfig       `mapstructure:"kms"`

...
import (
	...
	relaycross236 "chainmaker.org/chainmaker/vm-native/v2/v230/relay_cross2360"

	"chainmaker.org/chainmaker/vm-native/v2/sz/declaration"
	"chainmaker.org/chainmaker/vm-native/v2/sz/endorsement"
	"chainmaker.org/chainmaker/vm-native/v2/sz/exportrebate"
	"chainmaker.org/chainmaker/vm-native/v2/sz/real_estate"
	"chainmaker.org/chainmaker/vm-native/v2/sz/receipt"
	"chainmaker.org/chainmaker/vm-native/v2/sz/socialsecurity"

	"chainmaker.org/chainmaker/vm-native/v2/v230/accountmgr2320"
	...
	multisign210 "chainmaker.org/chainmaker/vm-native/v2/v210/multisign"
	...
	multisign220 "chainmaker.org/chainmaker/vm-native/v2/v220/multisign"
	pubkeymgr220 "chainmaker.org/chainmaker/vm-native/v2/v220/pubkeymgr"
	"chainmaker.org/chainmaker/vm-native/v2/v230/multisign2320"
	relaycross232 "chainmaker.org/chainmaker/vm-native/v2/v230/relay_cross2320"
	relaycross234 "chainmaker.org/chainmaker/vm-native/v2/v230/relay_cross2340"
)
...
func initContract(log protocol.Logger) map[string]common.Contract {
	...
	contracts[syscontract.SystemContract_CROSS_TRANSACTION.String()] = crosstx.NewCrossTransactionContract(log)
	...
	contracts[syscontract.SystemContract_RELAY_CROSS.String()] = relaycross.NewRelayCrossManager(log)
	contracts[syscontract.SystemContract_T.String()] = testcontract.NewManager(log)
	contracts[syscontract.SystemContract_TX_ASSIGN.String()] = txassign.NewContract(log)
	contracts[syscontract.SystemContract_REAL_ESTATE.String()] = real_estate.NewRealEstate(log)
	contracts[syscontract.SystemContract_ENDORSEMENT.String()] = endorsement.NewEndorsement(log)
	contracts[syscontract.SystemContract_RECEPIT.String()] = receipt.NewReceipt(log)
	contracts[syscontract.SystemContract_DECLARATION.String()] = declaration.NewDeclaration(log)
	contracts[syscontract.SystemContract_EXPORT_REBATE.String()] = exportrebate.NewExportRebate(log)
	contracts[syscontract.SystemContract_SOCIAL_SECURITY.String()] = socialsecurity.NewSocialSecurity(log)
	...
	contracts[multiSign210] = multisign210.NewMultiSignContract(log)
	...
	contracts[multiSign220] = multisign220.NewMultiSignContract(log)
	...
	contracts[multiSign2320] = multisign2320.NewMultiSignContract(log)
	contracts[accountManager2320] = accountmgr2320.NewAccountManager(log)
	contracts[relayCross2320] = relaycross232.NewRelayCrossManager(log)
	contracts[relayCross2340] = relaycross234.NewRelayCrossManager(log)
	contracts[relayCross2360] = relaycross236.NewRelayCrossManager(log)

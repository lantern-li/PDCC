...
func registerTestContractMethods(log protocol.Logger) map[string]common.ContractFunc {
	...
	methodMap["Sleep"] = common.WrapResultFunc(runtime.timeout)
	return methodMap
}
...
//put put state by key="k" value="v"
func (r *ManagerRuntime) timeout(context protocol.TxSimContext, parameters map[string][]byte) ([]byte, error) {
	k := parameters["k"]
	v := parameters["v"]
